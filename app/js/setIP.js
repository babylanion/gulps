...
//临时添加
    ['','三沙市','sansha','hn_ss','460300'],
    ['','襄阳市','xiangyang','hb_xy','420600'],
    ['','菏泽','heze','sd_hz','371700'],
    ['','康定','kangding','sc_kd','513301'],
    ['','普洱','puer','yn_pe','530800']
);

/*openCityList*/
var openCityListArr = new Array(
    ['0372', '安阳市', 'anyang', 'hn_ay', '410500'],
    ['010', '北京市', 'beijing', 'bj', '110000'],
    ['022', '天津市', 'tianjin', 'tj', '120000'],
    ['022', '滨海', 'binhai', 'bh', '121000'],
    ['023', '重庆市', 'chongqing', 'cq', '500000'],
    ['028', '成都市', 'chengdu', 'sc_cd', '510100'],
    ['0431', '长春市', 'changchun', 'jl_cc', '220100'],
    ['0769', '东莞市', 'dongguan', 'gd_d', '441900'],
...
jQuery.cookie('auto_iploc','');//清cookie
...
$(function () {
    if (auto_iploc == undefined || auto_iploc == null || auto_iploc == "") {
        ...
        $.ajax({
            url: 'http://api.auto.ifeng.com/app/api/ip_check.php',
            type: 'get',
            data:{code:getNum(jQuery.cookie("auto_iploc")),ocode:ocode,ip:ip},
            dataType: 'jsonp',
            jsonp: 'CallBack',
